...
Original file is located at
    https://colab.research.google.com/drive/11aEBWUVWeeTHorS49pYJs_zbdnVKgg12
"""
...
def choose_k_silhouette(Xc, k_min=1, k_max=10, random_state=0):
    ...
    # também comparamos com k=1 como opção "simples"
...
# =========================
Nr = 100
test_size = 0.30  # treino/teste (não especificado; padrão 70/30)

# Padronização ANTES do PCA e dos classificadores (boa prática para sensores/escala)
...
# Critério objetivo (conforme enunciado): reduzir dimensão SEM piorar desempenho
